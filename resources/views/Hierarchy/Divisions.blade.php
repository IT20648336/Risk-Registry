...
<tr>
    ...
    <label class="switch">
    @if($data->Status  == 'Active')
    <input type="checkbox"  checked onchange="ChangeDivisionStatus('ChangeDivisionStatus?Id={{$data->Id}}&NextStatus=Inactive'); return false;" >
    @elseif($data->Status  == 'Inactive')
    <input type="checkbox"  onchange="ChangeDivisionStatus('ChangeDivisionStatus?Id={{$data->Id}}&NextStatus=Active'); return false;" >
    @endif       
    <span  class="slider"></span>
    </label>
    </td>  
    <td>
    <input class="button" data-toggle="modal" data-target="#Edit" style="height: 20px; margin-top: 1px;" type="button" value="Edit" onclick="GetDivisionData('GetDivisionData?RowId={{$data->Id}}&Name={{$data->Name}}&Spoc={{$data->Spoc}}&Email={{$data->Email}}&Mobile={{$data->Mobile}}&Department_Name={{$data->Department_Name}}&Department_Id={{$data->Department_Id}}'); return false;" />
    </td>
</tr> 
@endforeach
</tbody>

...
<?php $__currentLoopData = $UserData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<tr>
    <td>
    <h4><?php echo e($data->User_Name); ?></h4>
    </td>
    <td>
    ...
    <td>
    <h4><?php echo e($data->Role); ?></h4>
    </td>
    <td>
    <label class="switch">
    <?php if($data->Status  == 'Active'): ?>
    <input type="checkbox"  checked onchange="ChangeUserStatus('ChangeUserStatus?Id=<?php echo e($data->Id); ?>&NextStatus=Inactive'); return false;" >
    <?php elseif($data->Status  == 'Inactive'): ?>
    <input type="checkbox"  onchange="ChangeUserStatus('ChangeUserStatus?Id=<?php echo e($data->Id); ?>&NextStatus=Active'); return false;" >
    <?php endif; ?>       
    <span  class="slider"></span>
    </label>
    </td>  
    <td>    
    <input class="button" style="height: 20px; margin-top: 1px;" type="button" value="Edit" data-toggle="modal" data-target="#EditUser" onclick="GetUserData('GetUserData?Username=<?php echo e($data->User_Name); ?>&Name=<?php echo e($data->Name); ?>&Email=<?php echo e($data->Email); ?>&Role=<?php echo e($data->Role); ?>&RowId=<?php echo e($data->Id); ?>'); return false;" />&nbsp;
    <input class="button" style="height: 20px; margin-top: 1px;" type="button" value="Assign" data-toggle="modal" data-target="#AssignUserDivision" onclick="GetAssignedUserDivision('GetAssignedUserDivision?Username=<?php echo e($data->User_Name); ?>'); return false;" />
    </td>
</tr>
...
<?php /**PATH /data/RiskRegistry/resources/views/User/Users.blade.php ENDPATH**/ ?>
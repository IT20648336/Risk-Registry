...
<body>
    ...
    <div class="scrollit1">
        <table id="user_table" style="font-weight: bold; margin-top:10px;">
            ...
            <tbody class="tbody-wrapper">
                ...
                <tr class="user_row" data-division="<?php echo e($user->Division_Name); ?>">
                    <td>
                        <input type="checkbox" name="user[]" value="<?php echo e($user->User_Name); ?>"
                            data-division="<?php echo e($user->Division_Name); ?>" data-name="<?php echo e($user->Name); ?>">
                    </td>
                    <td><h4><?php echo e($user->Name); ?></h4></td>
                    <td><h4><?php echo e($user->Division_Name); ?></h4></td>
                    <td><h4><?php echo e($user->Email); ?></h4></td>
                    <td><h4><?php echo e($user->Mobile); ?></h4></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
    ...
    <table style="width:100%; margin: 0px;"> 
        <tr>
            <td>
                <img src="<?php echo e(asset('images/EmailReminder.png')); ?>" style="width: 30px; height: 30px;">
    ...
    <div id="selected_info">
          Selected Users: <span id="selected_users_count"><?php echo e(count($selected_users ?? [])); ?></span> | Selected Divisions:                                  <span id="selected_divisions_count"><?php echo e(count($selected_divisions ?? [])); ?></span>
    </div>
</body>
</html><?php /**PATH /data/RiskRegistry/resources/views/AdminFunctions/Reminders.blade.php ENDPATH**/ ?>
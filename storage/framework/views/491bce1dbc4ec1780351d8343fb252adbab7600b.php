        ...
        <form method="post" id="sample_form" class="form-horizontal">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Name : </label>
                    <input type="text" name="brc" id="brc" class="form-control" />
                </div>
                <div class="form-group">
                    <label>Name : </label>
...
$(document).ready(function() {
    ...
    $('#sample_form').on('submit', function(event){
        ...
        if($('#action').val() == 'Add')
        {
            action_url = "<?php echo e(route('users.store')); ?>";
        }
 
        if($('#action').val() == 'Edit')
        {
            action_url = "<?php echo e(route('users.update')); ?>";
        }
...
<?php echo $__env->make('NavBar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/RiskRegistry/resources/views/demo.blade.php ENDPATH**/ ?>
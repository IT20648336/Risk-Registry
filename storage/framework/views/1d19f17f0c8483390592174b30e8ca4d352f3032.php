...
<div class="center">
  <button id="show-submit">+Add New Department</button>
</div>
...
<div class="popup">
  ...
  <h2>Add Department</h2> 
    <div class="form-element">
        <label for="Company_Name">Enter Company</label>
...
<form method="post" align="center" enctype="multipart/form-data" id="EditDepartment" > 
  <?php echo csrf_field(); ?>
<table id="customers" style="margin-top:80px; width:90%;postion:absolute;left:10%">
...
<?php echo $__env->make('NavBar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/RiskRegistry/resources/views/Department/Department.blade.php ENDPATH**/ ?>
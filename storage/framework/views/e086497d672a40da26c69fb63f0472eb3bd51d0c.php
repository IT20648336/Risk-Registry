...
<tr>
    ...
    <input type="checkbox"  checked onchange="ChangeDepartmentStatus('ChangeDepartmentStatus?Id=<?php echo e($data->Id); ?>&NextStatus=Inactive'); return false;" >
    <?php elseif($data->Status  == 'Inactive'): ?>
    <input type="checkbox"  onchange="ChangeDepartmentStatus('ChangeDepartmentStatus?Id=<?php echo e($data->Id); ?>&NextStatus=Active'); return false;" >
    <?php endif; ?>       
    <span  class="slider"></span>
    </label>
    </td>  
    <td>
    <input class="button" data-toggle="modal" data-target="#Edit" style="height: 20px; margin-top: 1px;" type="button" value="Edit" onclick="GetDepartmentData('GetDepartmentData?RowId=<?php echo e($data->Id); ?>&Name=<?php echo e($data->Name); ?>&Contact=<?php echo e($data->Contact); ?>&Email=<?php echo e($data->Email); ?>&Mobile=<?php echo e($data->Mobile); ?>'); return false;" />
    </td>
</tr>
...
</script><?php /**PATH /data/RiskRegistry/resources/views/Hierarchy/Departments.blade.php ENDPATH**/ ?>
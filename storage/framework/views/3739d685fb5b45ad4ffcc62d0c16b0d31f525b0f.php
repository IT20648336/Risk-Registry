...
<table style = "display:none;">
    ...
    <tbody>
        <?php $__currentLoopData = $categoryDataWithNumber; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number => $categoryData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <tr>
                <td><?php echo e($categoryNumber); ?></td>
                <td><?php echo e($categoryName); ?></td>
                <td><?php echo e($averageLHIndex); ?></td>
                <td><?php echo e($averageILIndex); ?></td>
                <td style="background-color: <?php echo e($colorCode); ?>; width: 20px;"></td>
            </tr>
      ...
      <table class="Dashboard_table">
        ...
        <tbody>
          ...
          <tr style="border-style: hidden">
            <?php for($j = 0; $j < 5; $j++): ?>
            <td style="background-color: <?php echo e($colorMatrix[$j][$i]); ?>; width: 50px; height: 78px">
              <?php $__currentLoopData = $categoryDataWithNumber; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryNumber => $categoryData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              $averageLHIndex = $categoryData['LH_Avg'];
              $averageILIndex = $categoryData['IL_Avg'];
              ?>
              <?php if($j + 1 == $averageILIndex && $i + 1 == $averageLHIndex): ?>
              <span class="circle circle-financial"><?php echo e($categoryNumber); ?></span>
              <?php endif; ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </td>
            <?php endfor; ?>
            ...
            <tbody>
              <tr>
                <td style="text-align: center;">
                  <?php $__currentLoopData = $categoryCountsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $quarters): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  $prevQuarter = '';
                  ?>
                  <?php $__currentLoopData = $quarters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quarter => $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($quarter === $currentQuarter): ?>
                  <tbody>
                    <?php
                    $categoryNumber = 1;
                    ?>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <tr>
                      <td style="position: relative; padding: 20px;">
                        <div style="position: absolute; bottom: -10px; left: 50%; transform: translateX(-50%); width: 25px; height: 25px;">
                          <div style="position: absolute; top: -23%; left: 50%; transform: translate(-50%, -50%); width: 35px; height: 30px; background-color: <?php echo e($colorCode); ?>;"></div>
                          <div style="position: absolute; top: -23%; left: 50%; transform: translate(-50%, -50%); width: 25px; height: 25px; background-color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                            <?php echo e($categoryNumber); ?>

                          </div>
                        </div>
                      </td>
                      <td><h4><?php echo e($category); ?></h4></td>
                      <td style="display:none;"><?php echo e($data['count']); ?></td>
                      <?php
                      $changeText = '-';
                      if ($prevQuarter != '') {
                      ...
                      <td><?php echo $changeText; ?></td>
                      <td style="display:none;"><?php echo e($averageLHIndex); ?></td>
                      <td style="display:none;"><?php echo e($averageILIndex); ?></td>
                      <td style="display:none; background-color: <?php echo e($colorCode); ?>; width: 20px;"></td>
                    </tr>
                    <?php
                    $categoryNumber++;
                    ?>
...
<table id="quarter-table" style="position:absolute; top:1400px; width:100px; display:none;">
    ...
    <tbody>
       <?php $__currentLoopData = $categoryCountsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $quarters): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $__currentLoopData = $quarters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quarter => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $__currentLoopData = $data['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if(!empty($categoryName) && $categoryName === $category && $categoryData !== null && $categoryData['count'] !== null && $categoryData['likelihood'] !== null && $categoryData['impact'] !== null): ?>
                          <?php
                          ...
                          ?>
                          <tr>
                              <td><?php echo e($year); ?> - <?php echo e($quarter); ?></td>
                              <td><?php echo e($category); ?></td>
                              <td><?php echo e($categoryData['count']); ?></td>
                              <td><?php echo e($categoryData['likelihood']); ?></td>
                              <td><?php echo e($categoryData['impact']); ?></td>
...
</script><?php /**PATH /data/RiskRegistry/resources/views/Dashboard.blade.php ENDPATH**/ ?>
...
if($data->Owner_Username == $User):
$AssignedType='Risk-Owner';
elseif( $data->Request_Status != $User):
$AssignedType='Action-Owner';
else:
...
</div><?php /**PATH /data/RiskRegistry/resources/views//Risk/AssignedRisks.blade.php ENDPATH**/ ?>